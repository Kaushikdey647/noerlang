#include<bits/stdc++.h>
#include</home/amit/Sem7/Compiler_Design/20CS01035_Amit_Kumar_Pandit_5/Q2_A5/lex.h>
using namespace std;
...
void buildMap(string filename,map<string,string> &mp){
...
int main(){
    ...
    map<string,string> non_term_map;
    buildMap("term_map.txt",term_map);
    buildMap("non_term_map.txt",non_term_map);
   ...
   string input;
   get_string(filename, input,term_map);
